      ...
      request.post(
        ...
        (err, response, body) => {
          if (err) reject(err);
            ...
            } else reject(this._reasons.get(response.statusCode));
          }
        }
      );
    });
      ...
      request.get(
        ...
        (err, res, body) => {
          if (err) reject(err);
            ...
            else reject(this._reasons.get(res.statusCode));
          }
        }
      );
    });
      ...
      request.get(
        ...
        (err, res, body) => {
          if (err) reject(err);
            ...
            if (res.statusCode === 200) resolve(new Guilds(body));
            else reject(this._reasons.get(res.statusCode));
          }
        }
      );
      ...
      request.get(
        ...
        (err, res, body) => {
          if (err) reject(err);
            ...
            if (res.statusCode === 200) resolve(new Connections(body));
            else reject(this._reasons.get(res.statusCode));
          }
        }
      );
