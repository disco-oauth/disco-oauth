 ...
 * @property {{link: string, state: string}} The auth data generated for just one use. Contains link and state variable.
 */
class Client {
  /**
   ...
   * @returns {{expired: boolean, expiresIn: number, expireTimestamp: number}}
   *
