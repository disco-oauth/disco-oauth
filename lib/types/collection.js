...
class UserCollection extends Collection {
   ...
   * @param params Same parameters as a normal collection.
   */
  constructor(...params) {
    super(...params);
  }
...
class GuildsCollection extends Collection {
   ...
   * @param params Same as a normal collection's parameters.
   */
  constructor(...params) {
    super(...params);
  }
...
class ConnectionsCollection extends Collection {
   ...
   * @param params The same as a normal collection's parameters.
   */
  constructor(...params) {
    super(...params);
  }
