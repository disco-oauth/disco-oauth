...
class Guild {
   ...
   * @returns {{createdAt: Date, features: string[], isOwner: boolean, permissions: string[], createdTimestamp: number, name: string, iconHash: Object.icon, id: string, iconUrl: string, bannerUrl: string}}}
   */
  toJSON() {
