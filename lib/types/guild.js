...
class Guild {
   ...
   */
  constructor({ id, name, icon, banner, features = [], owner = false, permissions = 0 }) {
    this._id = id;
    this._name = name;
    this._iconHash = icon;
   ...
   */
  toJSON() {
    const { id, name, createdAt, createdTimestamp, features, iconHash, bannerHash, isOwner, permissions } = this;
