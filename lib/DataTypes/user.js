...
class DiscordUser {
  ...
  constructor(id, username, discriminator, avatar, bot, nitro, email, verified) {
    ...
    this.avatar = avatar ? `https://cdn.discordapp.com/avatars/${id}/${avatar}.${avatar.startsWith("a_") ? "gif" : "png"}` : `https://cdn.discordapp.com/embed/avatars/${parseInt(discriminator) % 5}.png`;
